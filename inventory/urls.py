...
urlpatterns = [
    ...
    path("mercadolibre/stock/", views.ml_stock_push, name="inventory_ml_stock_push"),
    ...
    path("koda/chat/", views.koda_chat, name="inventory_koda_chat"),
    path("koda/confirm/", views.koda_confirm, name="inventory_koda_confirm"),
]
